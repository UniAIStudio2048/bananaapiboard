  ...
  let mapped = canvasAssets
    .map(a => {
      ...
      return {
        Id: assetId,
        Name: a.Name || a.name,
        URL: resolveAssetUrl(a.URL) || resolveAssetUrl(meta.assetUrl) || resolveAssetUrl(a.thumbnail_url) || resolveAssetUrl(a.url),
        ThumbnailURL: meta.thumbnailUrl || a.thumbnail_url || '',
        providerType: meta.providerType || activeProvider.value,
...
function handleAssetDragStart(e, asset) {
  const data = {
    ...
    assetUrl: asset.URL,
    thumbnailUrl: asset.ThumbnailURL || (asset.AssetType === 'Image' ? asset.URL : ''),
    providerType: asset.providerType || activeProvider.value,
