...
assert.equal(resolveDirectorAspectRatio({ aspectFrame: 'bad', aspectRatio: '' }), '16:9')
...
assert.equal(resolveDirectorAiRequestAspectRatio({ aspectFrame: 'bad', aspectRatio: '' }), '16:9')
