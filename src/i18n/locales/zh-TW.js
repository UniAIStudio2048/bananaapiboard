...
export default {
  ...
  canvas: {
    ...
    byteforCharacterLib: 'Bytefor角色庫',
  ...
  pointsType: {
    ...
    generate: '生成消耗',
    video_cost: '影片生成消耗',
    video_generation: '影片生成消耗',
    video_generate: '影片生成消耗',
    video_refund: '影片退款',
    ai_assistant: 'AI助手消耗',
    package_expired: '套餐到期清零',
    refund: '退款',
    voucher_redeem: '兌換券兌換',
    voucher: '兌換券',
    purchase_points: '積分購買',
    purchase: '購買',
    package_grant: '套餐贈送',
    package_renewal: '套餐續費',
    balance_to_points: '餘額劃轉',
    points_to_balance: '積分劃轉',
    admin_recharge: '管理員充值',
    system_grant: '系統贈送',
    compensation: '補償',
    manual_adjust: '手動調整',
    gift: '贈送',
