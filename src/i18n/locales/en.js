...
export default {
  ...
  directorStudio: {
    ...
    toolbar: {
      ...
      save: 'Save',
      captureTitle: 'Capture screenshot',
      capture: 'Capture',
      addToCanvasTitle: 'Add snapshot to canvas',
      canvas: 'Canvas',
      ...
      toggleLighting: 'Toggle lighting',
    ...
    items: {
      ...
      empty: 'No items',
      fallbackName: 'Item',
      defaultName: 'Item {count}',
      copyName: '{name} copy',
      pasteName: '{name} paste'
    },
    panorama: {
      title: 'Panorama',
      active: 'Active',
      flat: 'Flat',
      uploadTitle: 'Upload panorama',
      upload: 'Upload',
      clearTitle: 'Clear panorama',
      clear: 'Clear',
      noAssets: 'No image assets'
    },
    errors: {
      sceneLoadFailed: '3D scene failed to load',
      snapshotUploadFailed: 'Snapshot upload failed',
      sceneUnavailable: '3D scene unavailable',
      fileReadFailed: 'Failed to read image file',
      panoramaImportFailed: 'Panorama import failed'
    },
    projects: {
      title: 'Projects',
      saveActive: 'Save active project',
      saveNew: 'Save as new project',
      restore: 'Restore project',
      rename: 'Rename project',
      useSnapshotCover: 'Use current snapshot as cover',
    ...
    snapshots: {
      ...
      addToCanvas: 'Add selected snapshot to canvas',
      downloadActive: 'Download active snapshot',
      deleteSelected: 'Delete selected snapshot',
      selectCurrent: 'Select current snapshot',
      empty: 'No snapshots'
    },
    bodyStyles: {
      preset: 'Preset',
    ...
    inspector: {
      ...
      lean: 'Lean',
      armLength: 'Arm len',
      armThickness: 'Arm thick',
      legLength: 'Leg len',
      legThickness: 'Leg thick',
      customPoses: 'Custom poses',
      apply: 'Apply',
      none: 'none',
      savePose: 'Save pose',
      defaultPoseName: '{name} pose',
    ...
    shortcuts: {
      title: 'Shortcuts',
      dialogLabel: 'Director Studio shortcuts',
      ...
      copySelected: 'Copy selected',
      pasteItem: 'Paste item',
      undoItemOperation: 'Undo item operation',
      redoItemOperation: 'Redo item operation'
    },
    nodeCard: {
  ...
  canvas: {
    ...
    byteforCharacterLib: 'Bytefor Character Library',
    ...
    pointsDetail: 'Available points (Team + Permanent + Package)',
    // Storage quota
    ...
    shiftScrollDesc: 'Pan canvas horizontally',
    ctrlScroll: 'Ctrl+Scroll',
    ctrlScrollDesc: 'Pan canvas vertically',
    middleDrag: 'Middle Mouse Drag',
    middleDragDesc: 'Pan canvas',
    interactionMode: 'Interaction Mode',
    comfyuiMode: 'ComfyUI Mode',
    infiniteCanvasMode: 'Infinite Canvas Mode',
    comfyuiModeShort: 'ComfyUI',
    infiniteCanvasModeShort: 'Canvas',
    switchToComfyui: 'Switch to ComfyUI mode',
    switchToInfiniteCanvas: 'Switch to Infinite Canvas mode',
    comfyuiModeDesc: 'Left drag to pan, Shift/Ctrl drag to select, scroll to zoom',
    infiniteCanvasModeDesc: 'Left drag to select, scroll to pan, Ctrl+scroll to zoom',
    infiniteLeftDragDesc: 'Select nodes',
    infiniteScrollDesc: 'Pan canvas vertically',
    infiniteCtrlScrollDesc: 'Zoom at cursor',
    saveWorkflow: 'Save workflow',
    undoShortcut: 'Undo',
    redoShortcut: 'Redo',
    copyNode: 'Copy node',
    ...
    createImageNode: 'Create image node downstream and connect',
    createVideoNode: 'Create video node downstream and connect',
    createTextNode: 'Create text node downstream and connect',
    createAudioNode: 'Create audio node downstream and connect',
    downloadNodeFile: 'Download selected node file',
    ...
    videoNode: {
      ...
      motionImitation: 'Motion Imitation',
  ...
  user: {
    ...
    exchangeRateHint: 'Rate: {symbol}1 = {rate} permanent points',
    enterTransferAmount: 'Enter amount ({symbol})',
    confirmTransfer: 'Confirm Transfer',
    transferring: 'Transferring...',
    transferConfirm: 'Confirm Transfer',
    transferConfirmMsg: 'Convert {symbol}{amount} to {points} permanent points?',
    ...
    minTransferAmount: 'Minimum transfer amount is {symbol}1',
    insufficientBalanceTransfer: 'Insufficient balance. Current balance: {symbol}{balance}',
    // Redeem
    ...
    customAmountHint: 'Or enter custom amount ({symbol})',
    ...
    processing: 'Processing...',
    minRechargeAmount: 'Minimum recharge amount is {symbol}{amount}',
    maxRechargeAmount: 'Maximum recharge amount is {symbol}{amount}',
    ...
    ledgerType: {
      ...
      image_hd_upscale: 'HD Image Upscale',
      image_multiangle: 'Multi-angle Image Generation',
      image_panorama_generate: 'Panorama Image Generation',
  ...
  pointsType: {
    ...
    inviter_bonus: 'Invite Reward',
    invite: 'Invite Reward',
    invitee_bonus: 'Invited Reward',
    invited: 'Invited Reward',
    daily_checkin: 'Check-in Reward',
    checkin: 'Check-in Reward',
    generate_cost: 'Generation Cost',
    generate_cost_package: 'Generation Cost',
    generate_deduction: 'Generation Cost',
    generate: 'Generation Cost',
    video_cost: 'Video Generation Cost',
    video_generation: 'Video Generation Cost',
    video_generate: 'Video Generation Cost',
    video_refund: 'Video Refund',
    ai_assistant: 'AI Assistant Cost',
    package_expired: 'Package Expired Clear',
    refund: 'Refund',
    ...
    balance_to_points: 'Balance Transfer',
    points_to_balance: 'Points Transfer',
  ...
  onboarding: {
    ...
    interactionMode: {
      ...
      description: 'Choose your preferred canvas interaction style. You can switch anytime from the bottom-left corner.',
