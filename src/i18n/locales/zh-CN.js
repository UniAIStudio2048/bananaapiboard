...
export default {
  ...
  directorStudio: {
    ...
    errors: {
      sceneLoadFailed: '3D 场景加载失败',
      snapshotUploadFailed: '截图上传失败',
      sceneUnavailable: '3D 场景不可用',
      fileReadFailed: '读取图片失败',
      panoramaImportFailed: '全景图导入失败'
    },
    projects: {
      title: '项目',
      saveActive: '保存当前项目',
    ...
    snapshots: {
      title: '截图',
      capture: '截图',
      addToCanvas: '添加选中截图到画布',
      downloadActive: '下载当前截图',
      deleteSelected: '删除选中截图',
      selectCurrent: '选择当前截图',
      empty: '暂无截图'
    },
    bodyStyles: {
      preset: '预设',
    ...
    inspector: {
      ...
      none: '无',
      savePose: '保存姿势',
      defaultPoseName: '{name} 姿势',
      noItemSelected: '未选择元素',
      camera: '镜头',
      fov: '视角',
      lens: '镜头距离',
      lighting: '灯光',
    ...
    shortcuts: {
      ...
      copySelected: '复制选中',
      pasteItem: '粘贴元素',
      undoItemOperation: '撤销元素操作',
      redoItemOperation: '重做元素操作'
    },
    nodeCard: {
  ...
  canvas: {
    ...
    pointsDetail: '可用积分（团队积分 + 永久积分 + 套餐积分）',
    // 存储配额
    storageSpace: '存储空间',
    workflowCount: '工作流数量',
    ...
    startGenerate: '开始生成',
    toggleAIAssistant: '展开/收起 AI 灵感助手',
    createImageNode: '在下游创建图像节点并连线',
    createVideoNode: '在下游创建视频节点并连线',
    createTextNode: '在下游创建文本节点并连线',
    createAudioNode: '在下游创建音频节点并连线',
    downloadNodeFile: '下载选中节点的文件',
    ...
    nodeConfig: {
      ...
      storyboardGrid: { label: '分镜格子', desc: '创建可拖拽排序的图片网格' },
      ...
      seedanceCharacter: { label: 'Seedance 角色', desc: '火山引擎角色资产' }
    },
    // 图片节点快捷操作
    imageNode: {
      uploadImage: '上传图片',
  ...
  user: {
    ...
    exchangeRateHint: '汇率：1{unit} = {rate} 永久积分',
    enterTransferAmount: '输入金额（{unit}）',
    confirmTransfer: '确认划转',
    transferring: '划转中...',
    transferConfirm: '确认划转',
    transferConfirmMsg: '确认将 {symbol}{amount} 划转为 {points} 永久积分？',
    transferSuccess: '划转成功',
    transferSuccessMsg: '成功划转 {points} 积分到您的账户！',
    transferFailed: '划转失败，请重试',
    enterTransferAmount: '请输入划转金额',
    minTransferAmount: '最低划转金额为 1 {unit}',
    insufficientBalanceTransfer: '余额不足，当前余额 {symbol}{balance}',
    // 兑换
    voucherRedeem: '兑换码兑换',
    ...
    selectAmount: '选择金额',
    customAmountHint: '或输入自定义金额（{unit}）',
    paymentMethod: '支付方式',
    couponCode: '优惠券码（可选）',
    ...
    processing: '处理中...',
    minRechargeAmount: '最低充值金额为 {amount} {unit}',
    maxRechargeAmount: '最高充值金额为 {amount} {unit}',
